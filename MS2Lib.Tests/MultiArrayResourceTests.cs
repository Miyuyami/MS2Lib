...
{
    [TestClass]
    public class MultiArrayResourceTests
    {
        [TestMethod]
        public void Indexer_IndexSmallerThanSize_ExpectedResult()
        {
            var maf = new MultiArrayResource(TestResources.ResourceManager, "fileArray", 16, 16);
        ...
        {
            var expected = 6;
            var maf = new MultiArrayResource(TestResources.ResourceManager, "fileArray", 10, expected);
